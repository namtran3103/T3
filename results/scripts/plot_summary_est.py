...
if __name__ == '__main__':
    ...
    q_vals = parse_p50s(os.path.join(data_dir, 'holdout_query_est.txt'))
    p_vals = parse_p50s(os.path.join(data_dir, 'holdout_pipeline_est.txt'))
    t_vals = parse_p50s(os.path.join(data_dir, 'holdout_tuple_est.txt'))
    ...
    fig.tight_layout()
    out_path = os.path.join(data_dir, 'summary_est.png')
