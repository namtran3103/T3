...
if __name__ == '__main__':
    ...
    query    = parse_p50(os.path.join(data_dir, 'holdout_query_act.txt'))
    pipeline = parse_p50(os.path.join(data_dir, 'holdout_pipeline_act.txt'))
    tuple_   = parse_p50(os.path.join(data_dir, 'holdout_tuple_act.txt'))
    ...
    fig.tight_layout()
    out_path = os.path.join(data_dir, 'levels_act.png')
