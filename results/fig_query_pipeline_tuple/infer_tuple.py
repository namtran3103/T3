"""
Tuple-level inference for the query/pipeline/tuple comparison figure.

Uses act models from results/models/tuple-level/act/ with actual cardinalities.
...
Results are appended to tuple.txt in this directory.
"""
...
MODEL_DIR = SCRIPT_DIR.parent / "models" / "tuple-level" / "act"
OUT_FILE = SCRIPT_DIR / "tuple.txt"
...
def main() -> None:
    ...
    summary = (
        f"tuple-level (act): {total_queries} queries across {len(model_files)} holdouts | "
