"""
Tuple-level inference with estimated cardinalities for all models in this directory.
...
Usage (from T3 project root or this directory):
  python results/models/tuple-level/est/infer.py
"""
...
def main() -> None:
    ...
    for model_path in model_files:
        ...
        summary = (
            f"[{ts}] holdout={holdout} card=est n={len(errors)}"
